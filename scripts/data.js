...
const mockModules = [
    ...
    {
        id: 'cbse_python_basics_review',
        title: 'Python Basics & Data Types Review',
        description: 'Revision of Python fundamentals: Strings, Lists, Tuples, Dictionaries, and Basic Operators',
        icon: 'code',
        questionCount: 50,
        questions: [
            ...
            { text: "What is the output of 'Python' * 2?", options: ["PythonPython", "Python 2", "Error", "['Python', 'Python']"], correctAnswer: 0, explanation: "String multiplication repeats the string." },
            { text: "How do you start a multi-line comment in Python?", options: ["/*", "###", "''' or \"\"\"", "//"], correctAnswer: 2, explanation: "Triple quotes are used for multi-line strings/comments." },
            { text: "Which function is used to get the length of a list?", options: ["size()", "count()", "length()", "len()"], correctAnswer: 3, explanation: "len() returns the number of items." },
            { text: "What is the index of the last element in a list 'L' of size 'n'?", options: ["n", "n-1", "0", "-2"], correctAnswer: 1, explanation: "Indices range from 0 to n-1." },
            { text: "What does list(range(1, 10, 2)) produce?", options: [" [1, 2, 3, 4, 5, 6, 7, 8, 9]", "[1, 3, 5, 7, 9]", "[1, 10, 2]", "[2, 4, 6, 8]"], correctAnswer: 1, explanation: "range(start, stop, step) generates numbers from 1 to 9 with step 2." },
            { text: "Which method adds an element at a specific index in a list?", options: ["append()", "extend()", "insert()", "add()"], correctAnswer: 2, explanation: "insert(index, element) puts the element at the given position." },
            { text: "What is the output of bool(0)?", options: ["True", "False", "None", "Error"], correctAnswer: 1, explanation: "Numeric zero is considered False." },
            { text: "How do you create an empty dictionary?", options: ["{}", "dict()", "[]", "Both A and B"], correctAnswer: 3, explanation: "Both curly braces and the dict constructor work." },
            { text: "Which method returns all the keys of a dictionary?", options: ["get_keys()", "keys()", "all()", "index()"], correctAnswer: 1, explanation: "d.keys() returns a view object of keys." },
            { text: "What happens if you access a non-existent key in a dictionary using d[key]?", options: ["Returns None", "Raises KeyError", "Returns 0", "Adds the key"], correctAnswer: 1, explanation: "Accessing missing keys directly raises an error." },
            { text: "Which string method converts the first character to uppercase?", options: ["upper()", "capitalize()", "title()", "first()"], correctAnswer: 1, explanation: "capitalize() only uppercases the first character." },
            { text: "What is the result of '123'.isdigit()?", options: ["True", "False", "Error", "123"], correctAnswer: 0, explanation: "isdigit() checks if all characters are digits." },
            { text: "Which operator is used to check if two variables point to the same object?", options: ["==", "is", "in", "matches"], correctAnswer: 1, explanation: "'is' checks object identity." },
            { text: "What is the output of print(2 + 3 * 4)?", options: ["20", "14", "24", "10"], correctAnswer: 1, explanation: "Multiplication has higher precedence than addition." },
            { text: "How do you convert a string to a float?", options: ["str()", "int()", "float()", "convert()"], correctAnswer: 2, explanation: "float() constructor is used." },
            { text: "Which collection is unordered and does not allow duplicate elements?", options: ["List", "Tuple", "Set", "Dictionary"], correctAnswer: 2, explanation: "Sets are unordered collections of unique elements." },
            { text: "What is the output of 'hello'.find('z')?", options: ["-1", "0", "False", "Error"], correctAnswer: 0, explanation: "find() returns -1 if the substring is not found." },
            { text: "Which keyword is used to handle exceptions?", options: ["catch", "try", "error", "except"], correctAnswer: 1, explanation: "try...except block handles errors." },
            { text: "What does 'break' do in a loop?", options: ["Starts the next iteration", "Terminates the loop", "Pauses the loop", "Exits the function"], correctAnswer: 1, explanation: "break jumps out of the inner-most loop." },
            { text: "Which function generates a sequence of numbers?", options: ["series()", "range()", "list()", "sequence()"], correctAnswer: 1, explanation: "range() is a built-in function for sequences." },
            { text: "What is the output of print(1, 2, 3, sep='-')?", options: ["1 2 3", "123", "1-2-3", "Error"], correctAnswer: 2, explanation: "sep defines the separator between items." },
            { text: "Which of these is NOT a bitwise operator?", options: ["&", "|", "^", "&&"], correctAnswer: 3, explanation: "&& is not a Python operator (it's logical and 'and' in Python)." },
            { text: "How do you access the value of 'name' in d = {'name': 'Alice'}?", options: ["d[0]", "d('name')", "d['name']", "d.name"], correctAnswer: 2, explanation: "Dictionaries use square brackets with keys." },
            { text: "What is the result of 'abc' < 'abd'?", options: ["True", "False", "Error", "None"], correctAnswer: 0, explanation: "Strings are compared lexicographically." },
            { text: "Which method removes all items from a list?", options: ["remove()", "delete()", "clear()", "pop()"], correctAnswer: 2, explanation: "L.clear() empties the list." },
            { text: "What does 5 // 2 return?", options: ["2.5", "3", "2", "2.0"], correctAnswer: 2, explanation: "Floor division of 5 by 2 is 2." },
            { text: "What is the output of [i for i in range(3)]?", options: ["[0, 1, 2]", "[1, 2, 3]", "[0, 1, 2, 3]", "Error"], correctAnswer: 0, explanation: "List comprehension iterating over range(3)." },
            { text: "Which module is used for random number generation?", options: ["math", "random", "os", "sys"], correctAnswer: 1, explanation: "The random module." },
            { text: "What does random.randint(1, 5) return?", options: ["Random int between 1 and 4", "Random int between 1 and 5 (inclusive)", "Random float between 1 and 5", "Error"], correctAnswer: 1, explanation: "randint(a, b) is inclusive of both endpoints." },
            { text: "Which statement is used to import a specific function from a module?", options: ["import func from mod", "from mod import func", "include mod.func", "use mod.func"], correctAnswer: 1, explanation: "from...import syntax." },
            { text: "What is the default return value of a function in Python?", options: ["0", "False", "None", "''"], correctAnswer: 2, explanation: "Functions without return statements return None." },
            { text: "Which built-in function returns the absolute value?", options: ["abs()", "positive()", "norm()", "mag()"], correctAnswer: 0, explanation: "abs() function." },
            { text: "What is the result of len({'a': 1, 'b': 2})?", options: ["4", "1", "2", "error"], correctAnswer: 2, explanation: "len() of a dictionary is the number of key-value pairs." },
            { text: "Which method replaces occurrences of a substring?", options: ["change()", "modify()", "replace()", "swap()"], correctAnswer: 2, explanation: "str.replace(old, new)." },
            { text: "What is the outcome of 2.0 == 2?", options: ["True", "False", "Error", "None"], correctAnswer: 0, explanation: "Equality operator promotes integer to float for comparison." },
            { text: "Which keyword is used to skip the current iteration of a loop?", options: ["pass", "skip", "continue", "next"], correctAnswer: 2, explanation: "continue skips the rest of the loop body." },
            { text: "How do you check if 'x' is a key in dictionary 'd'?", options: ["d.has(x)", "x in d", "d.contains(x)", "x in d.values()"], correctAnswer: 1, explanation: "'in' operator checks for keys in dictionaries." },
            { text: "What is the output of print('Hello'[-1])?", options: ["H", "o", "e", "Error"], correctAnswer: 1, explanation: "-1 index accesses the last character." },
            { text: "Which method removes an item by its value from a list?", options: ["pop()", "remove()", "discard()", "del"], correctAnswer: 1, explanation: "remove(val) searches for 'val' and removes it." },
            { text: "What is the result of 3 ** 2?", options: ["6", "9", "5", "8"], correctAnswer: 1, explanation: "** is the power operator." },
            { text: "Which function converts an object to its string representation?", options: ["to_str()", "string()", "str()", "s()"], correctAnswer: 2, explanation: "str() function." },
            { text: "What does the 'none' keyword represent in Python?", options: ["Empty string", "Null value / Absence of value", "False", "Zero"], correctAnswer: 1, explanation: "None is a special constant representing null." },
            { text: "Which of the following is NOT a logical operator?", options: ["and", "or", "not", "xor"], correctAnswer: 3, explanation: "xor is not a built-in keyword in Python (but ^ is bitwise XOR)." },
            { text: "What is the output of print(tuple([1, 2, 3]))?", options: ["(1, 2, 3)", "[1, 2, 3]", "{1, 2, 3}", "1, 2, 3"], correctAnswer: 0, explanation: "tuple() converts a list to a tuple." },
            { text: "Which function is used to convert an integer to its binary string?", options: ["binary()", "bin()", "to_bin()", "hex()"], correctAnswer: 1, explanation: "bin() returns '0b...' string." }
        ]
    },
    {
        id: 'cbse_python_more_sql',
        title: 'Advanced SQL & Joins',
        description: 'Aggregate functions, Group By, Joins, and more SQL commands.',
        icon: 'database',
        questionCount: 50,
        questions: [
            { text: "Which SQL function returns the average value of a numeric column?", options: ["AVG()", "MEAN()", "AVERAGE()", "SUM()/COUNT()"], correctAnswer: 0, explanation: "AVG() is the built-in aggregate function for average." },
            { text: "Which keyword is used to sort the result-set?", options: ["SORT BY", "ORDER BY", "ARRANGE BY", "GROUP BY"], correctAnswer: 1, explanation: "ORDER BY is used for sorting." },
            { text: "Which clause is used with aggregate functions to group the result-set by one or more columns?", options: ["GROUP BY", "ORDER BY", "HAVING", "WHERE"], correctAnswer: 0, explanation: "GROUP BY organizes data into groups for aggregation." },
            { text: "The HAVING clause was added to SQL because the ________ keyword could not be used with aggregate functions.", options: ["SELECT", "WHERE", "GROUP BY", "ORDER BY"], correctAnswer: 1, explanation: "WHERE cannot filter on aggregate results; HAVING can." },
            { text: "Which JOIN returns all records from the left table, and the matched records from the right table?", options: ["INNER JOIN", "LEFT JOIN", "RIGHT JOIN", "FULL JOIN"], correctAnswer: 1, explanation: "LEFT JOIN (or LEFT OUTER JOIN) includes all rows from the left table." },
            { text: "What is a 'Primary Key'?", options: ["A key that can have null values", "A unique identifier for each record in a table", "A key that links two tables", "The first column in every table"], correctAnswer: 1, explanation: "Primary keys must be unique and non-null." },
            { text: "Which operator is used to select values within a range?", options: ["WITHIN", "BETWEEN", "RANGE", "IN"], correctAnswer: 1, explanation: "BETWEEN searches for values in a range (inclusive)." },
            { text: "What does the 'DISTINCT' keyword do?", options: ["Selects duplicate rows", "Removes duplicate rows from the result set", "Sorts the rows", "Counts the number of rows"], correctAnswer: 1, explanation: "DISTINCT filters out duplicate values." },
            { text: "Which of the following is an aggregate function?", options: ["SELECT", "UPDATE", "SUM()", "DELETE"], correctAnswer: 2, explanation: "SUM() calculates the total of a numeric column." },
            { text: "SQL is not case-sensitive for commands like SELECT, but it may be case-sensitive for ________ depending on the DB setting.", options: ["Column names", "Data values", "Table names", "All of the above"], correctAnswer: 3, explanation: "Case sensitivity depends on the database engine and collation settings." },
            { text: "Which command is used to delete a table and its structure?", options: ["DELETE TABLE", "DROP TABLE", "REMOVE TABLE", "TRUNCATE TABLE"], correctAnswer: 1, explanation: "DROP TABLE removes the entire table from the database." },
            { text: "What is the result of COUNT(*) on a table with 5 rows?", options: ["1", "5", "0", "4"], correctAnswer: 1, explanation: "COUNT(*) counts the total number of records." },
            { text: "Which keyword is used to fetch only a certain number of records?", options: ["LIMIT", "TOP", "FETCH", "Both A and B (depending on SQL dialect)"], correctAnswer: 3, explanation: "MySQL uses LIMIT, while SQL Server uses TOP." },
            { text: "How do you select only the rows where the name starts with 'A'?", options: ["WHERE name = 'A%'", "WHERE name LIKE 'A%'", "WHERE name LIKE '%A'", "WHERE name = 'A*'"], correctAnswer: 1, explanation: "The % wildcard represents zero or more characters." },
            { text: "Which operator matches a single character in a LIKE pattern?", options: ["%", "*", "_", "?"], correctAnswer: 2, explanation: "Underscore (_) matches exactly one character." },
            { text: "What is 'Referential Integrity'?", options: ["Data is stored in multiple places", "Ensuring relationships between tables remain consistent (Foreign Keys)", "Encryption of data", "Using primary keys everywhere"], correctAnswer: 1, explanation: "It ensures that a foreign key value always refers to an existing primary key." },
            { text: "Which command is part of DDL?", options: ["SELECT", "INSERT", "ALTER", "UPDATE"], correctAnswer: 2, explanation: "ALTER changes the table structure." },
            { text: "Which clause is used to filter group results?", options: ["WHERE", "HAVING", "LIMIT", "FROM"], correctAnswer: 1, explanation: "HAVING filters the output of a GROUP BY." },
            { text: "SQL stands for Structured ________ Language.", options: ["Queue", "Query", "Quantity", "Quality"], correctAnswer: 1, explanation: "Structured Query Language." },
            { text: "What is a Tuple in a relational database?", options: ["A column", "A row", "A table", "A key"], correctAnswer: 1, explanation: "A tuple is synonymous with a record or row." },
            { text: "What is the Cardinality of a table with 10 rows and 3 columns?", options: ["3", "10", "30", "13"], correctAnswer: 1, explanation: "Cardinality is the number of rows." },
            { text: "What is the Degree of a table with 10 rows and 5 columns?", options: ["10", "5", "50", "2"], correctAnswer: 1, explanation: "Degree is the number of columns." },
            { text: "Which Join returns only the rows where there is a match in both tables?", options: ["INNER JOIN", "OUTER JOIN", "LEFT JOIN", "RIGHT JOIN"], correctAnswer: 0, explanation: "INNER JOIN selects records with matching values in both tables." },
            { text: "How do you change 'Delhi' to 'Mumbai' in the 'City' column of 'Students' table?", options: ["UPDATE Students SET City='Mumbai' WHERE City='Delhi'", "CHANGE Students City='Mumbai'", "MODIFY Students SET Mumbai WHERE Delhi", "UPDATE Students City='Mumbai'"], correctAnswer: 0, explanation: "The UPDATE...SET...WHERE syntax is used for modification." },
            { text: "Which constraint ensures that all values in a column are different?", options: ["PRIMARY KEY", "UNIQUE", "NOT NULL", "CHECK"], correctAnswer: 1, explanation: "UNIQUE constraint prevents duplicate entries." },
            { text: "Which function is used to find the highest value in a column?", options: ["MAX()", "HIGHEST()", "TOP()", "LARGE()"], correctAnswer: 0, explanation: "MAX() returns the maximum value." },
            { text: "Is NULL the same as zero or a blank space?", options: ["Yes", "No", "Only in MySQL", "Only for strings"], correctAnswer: 1, explanation: "NULL represents a missing or unknown value." },
            { text: "What is the default order of ORDER BY?", options: ["Descending", "Ascending", "Random", "None"], correctAnswer: 1, explanation: "Ascending (ASC) is the default." },
            { text: "Which command removes all rows from a table but keeps the structure?", options: ["DROP", "DELETE", "TRUNCATE", "Both B and C"], correctAnswer: 3, explanation: "Both DELETE FROM table and TRUNCATE TABLE remove all records." },
            { text: "Which operator is used to combine the result-set of two or more SELECT statements?", options: ["JOIN", "UNION", "MERGE", "PLUS"], correctAnswer: 1, explanation: "UNION combines distinct rows from multiple queries." },
            { text: "What is a Foreign Key?", options: ["A key used to encrypt the database", "A column that refers to the primary key of another table", "A key that comes from a different database vendor", "A redundant primary key"], correctAnswer: 1, explanation: "Foreign keys establish relationships between tables." },
            { text: "Which SQL block is used for comments?", options: ["--", "/* ... */", "#", "All of the above (in many dialects)"], correctAnswer: 3, explanation: "Many SQL versions support -- , # and C-style comments." },
            { text: "What does the ROLLBACK command do?", options: ["Saves changes permanently", "Undoes the current transaction", "Deletes the database", "Restarts the server"], correctAnswer: 1, explanation: "ROLLBACK reverts changes since the last COMMIT." },
            { text: "Which function sums a column's values?", options: ["ADD()", "TOTAL()", "SUM()", "COUNT()"], correctAnswer: 2, explanation: "SUM() aggregate function." },
            { text: "What is the use of the IN operator?", options: ["To check for a value inside a list or subquery", "To insert data", "To index a column", "To join tables"], correctAnswer: 0, explanation: "IN allows multiple values in a WHERE clause." },
            { text: "Which join returns all records from the RIGHT table?", options: ["LEFT JOIN", "RIGHT JOIN", "INNER JOIN", "FULL JOIN"], correctAnswer: 1, explanation: "RIGHT JOIN includes all rows from the right-hand table." },
            { text: "How do you select everyone except 'John'?", options: ["WHERE name NOT 'John'", "WHERE name <> 'John'", "WHERE name != 'John'", "Both B and C"], correctAnswer: 3, explanation: "Both <> and != mean 'not equal' in most SQL flavors." },
            { text: "What is an Alias in SQL?", options: ["A temporary name for a table or column", "A permanent change to a column name", "An encrypted username", "A hidden database"], correctAnswer: 0, explanation: "The AS keyword is used to create an alias." },
            { text: "Which command is used to create a new database?", options: ["NEW DATABASE", "CREATE DATABASE", "ADD DATABASE", "SET DATABASE"], correctAnswer: 1, explanation: "CREATE DATABASE command." },
            { text: "What is the 'View' in SQL?", options: ["A physical copy of the table", "A virtual table based on a SELECT statement", "The user interface of the DB", "A screenshot of data"], correctAnswer: 1, explanation: "Views are virtual tables that store a query definition." },
            { text: "Which constraint used to limit the value range that can be placed in a column?", options: ["DEFAULT", "CHECK", "INDEX", "LIMIT"], correctAnswer: 1, explanation: "CHECK constraint validates data before insertion." },
            { text: "How do you find the number of unique cities in a table?", options: ["COUNT(City)", "COUNT(DISTINCT City)", "DISTINCT(COUNT(City))", "UNIQUE(City)"], correctAnswer: 1, explanation: "COUNT(DISTINCT column) counts non-duplicate entries." },
            { text: "What defines the structure of a relation in terms of attributes and domains?", options: ["Schema", "Instance", "Query", "Transaction"], correctAnswer: 0, explanation: "The database schema is the skeletal structure." },
            { text: "Which SQL command is used to add a new column to an existing table?", options: ["UPDATE TABLE", "MODIFY TABLE", "ALTER TABLE", "ADD TABLE"], correctAnswer: 2, explanation: "ALTER TABLE table_name ADD column_name datatype." },
            { text: "What is the output of SELECT 10 + NULL?", options: ["10", "0", "NULL", "Error"], correctAnswer: 2, explanation: "NULL propagates in arithmetic operations." },
            { text: "Which clause restricts the rows that are grouped?", options: ["WHERE", "HAVING", "ORDER BY", "Both A and B"], correctAnswer: 3, explanation: "WHERE filters rows before grouping; HAVING filters the groups." },
            { text: "The cross product of two relations with degree 2 and 3 results in a relation with degree ________.", options: ["6", "5", "1", "0"], correctAnswer: 1, explanation: "Degree of Cartesian product = Sum of degrees (2 + 3 = 5)." },
            { text: "The cardinality of a cross product of two relations with 5 and 4 tuples is ________.", options: ["9", "20", "1", "2"], correctAnswer: 1, explanation: "Cardinality of Cartesian product = Product of cardinalities (5 * 4 = 20)." },
            { text: "Which SQL command allows you to grant permissions to users?", options: ["GIVE", "ALLOW", "GRANT", "PERMIT"], correctAnswer: 2, explanation: "GRANT is the DCL command for permissions." },
            { text: "What is the first step in normalized table design usually?", options: ["Eliminating duplicate columns", "Creating primary keys", "Adding foreign keys", "Removing all NULLs"], correctAnswer: 1, explanation: "Ensuring each table has a unique identifier is fundamental." }
        ]
    }
];
